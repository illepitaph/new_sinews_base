    ...
    <>
      <LeftBlackTitle>
        <span className={styles.blackShadow}>
          _<span className={styles.redShadow}>_</span>_ s
          <span className={styles.redShadow}>a</span>ra
          <br />
          <span className={styles.redShadow}> d</span> e{" "}
          <span className={styles.redShadow}>n</span>{" "}
          <span className={styles.redShadow}>i</span> z <br />
          akan<span className={styles.redShadow}>t</span> _
          <span className={styles.redShadow}>_</span>_
        </span>
      </LeftBlackTitle>
    </>
  );
...
export function AkantRawText2() {
  return (
    <>
      <RightGrayTitle>
        <span className={styles.redShadow}>h o w</span>
      </RightGrayTitle>
      <h3 className={styles.bigT}>T</h3>
      <RightGrayTitle>
        <span className={styles.redShadow}>lang ed</span>
      </RightGrayTitle>
    </>
  );
}
...
to pray.           `}
        <i>Now the form and not the substance of the script</i>
        {`
                       `}
...
export function AkantRawText4() {
    ...
    <>
      <GalleryLineation>
        {`T-Reason for the tree ::
          ...
          Bitches point back and say `}
        <i>T</i>
        {`.
          See ? `}
        <i>T is where I’m from</i>
        {`.
          I come from the seat of `}
        <i>the empire</i>
        {`
          `}
  ...
  And I’m very well placed in that hierarchy.`}
      </GalleryLineation>
    </>
  );
}
    ...
    <>
      <GalleryLineation>
        {`             T runs ahead and lies
             ...
             We watch T-Magnificent, attending him with honor.`}
      </GalleryLineation>
    </>
  );
}
...
What were all of T’s names before ?`}
      </GalleryLineation>
    </>
  );
}
...
scary magic coming from my absent hand.`}
      </GalleryLineation>
    </>
  );
}
