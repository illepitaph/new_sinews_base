...
export function TwoEyesRawText2() {
  return (
    <>
      <CenterBlackTitle>
        <span className={styles.grayShadow}>_ vi _ khi _ nao _</span>
      </CenterBlackTitle>
    </>
  );
}
    ...
    <>
      <GalleryLineation>
        ...
        {`The tears of the professor are falling
                                                                  ...
                                                                  itself by thinking in sotto voce, `}
        <i>I am the only one who moves</i>
        {`
                                                                  `}
        <i>the seasons around</i>
        {`, and says out loud, “You are eating my
    ...
    <>
      <GalleryLineation>
        {`After the winter gives the keys of daylight  
                                                                   ...
                                                                   company: `}
        <i>You and the trees. You will meet them again.</i>
      </GalleryLineation>
    </>
  );
}
