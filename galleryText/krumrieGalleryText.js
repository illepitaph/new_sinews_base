    ...
    <>
      <CenterGrayTitle>
        <span className={styles.blackShadow}>
          ...
          <br /> k <span className={styles.alternateShadow}> r</span> u
...
See, the grass keeps the dunes in place.`}
      </GalleryLineation>
    </>
  );
}
  ...
  return (
    <>
      <GalleryLineation>
        ...
        >{`            Each location is parallel. Here. When I walk here the canyon opens. Its sides. A river. The canyon
     ...
     I walk toward—the desert—ground moves. The canyon empties—here—the field—at the center—of
          the desert—
     your eyes behind—layers of glass—see me here—I walk—the river’s cold in shadow.`}</span>
      </GalleryLineation>
    </>
  );
}
...
We have forms. We think we know them.`}
      </GalleryLineation>
    </>
  );
}
...
export function KrumrieRawText7() {
  return (
    <>
      <GalleryLineation>
        <span className={styles.reducedLineation}>
