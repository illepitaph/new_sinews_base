...
export default function Guanyin() {
  return (
      <div>
          <Head>
            <title>k-ming_chang ~ guanyin — new_sinews</title>
      ...
      <br/>
      <br/>
      <RightGrayTitle><h3 className={styles.title}>guanyin</h3></RightGrayTitle>
      <RightBlackTitle><h3 className={styles.title}>k-ming chang</h3></RightBlackTitle>
      <br/>
      <StandardProse>
