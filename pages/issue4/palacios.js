...
Palacios.title =
  "gabriel_palacios ~ poems_from_lunar_hilton_elegy — new_sinews";
Palacios.pieceName =
  "gabriel_palacios ~ poems_from_lunar_hilton_elegy — new_sinews";
Palacios.description =
  "_Gabriel Palacios_poetry_POEMS FROM LUNAR HILTON ELEGY_new_sinews_issue4_";
Palacios.image = "https://www.newnewsinews.com/images/PalaciosBackground.jpg";
...
export default function Palacios() {
  return (
    <>
      ...
      <CenterBlackTitle>
        poems from <br />
        <br />_<i>lunar</i>_<i>hilton</i>_<i>elegy</i>
      </CenterBlackTitle>
      ...
      <CenterGrayTitle>
        <span className={styles.title}>
          ... <span className={styles.inverseShadow}>g</span> a{" "}
          <span className={styles.inverseShadow}>b </span>
          <span className={styles.titleShadow}> r </span>{" "}
          ...
          <span className={styles.inverseShadow}>l </span>a{" "}
          <span className={styles.inverseShadow}>c </span>
...
`}
        <i>Tec out the dresser</i>
        {` out the cubicles H&R Block occupies
           in         Walmart
                       prisoner at sea
