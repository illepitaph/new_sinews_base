...
Issue4.description =
  "_newsinews_issue4_Brandon Shimoda+K-Ming Chang+Evan Isoline+Christa Romanosky+Gabriel Palacios+Allison Hummel+Mike Corrao+Vi Khi Nao+Grant Maierhofer_";
      ...
      <div className={styles.pageStructure}>
        <div className={styles.issueContents}>
          <div className={styles.workColumn}>
            <Link href="/issue4/hour" passHref>
              <div className={styles.workLink}>
                ... brandon shimoda + the hour of the rat ...
              </div>
            </Link>
          </div>
          <div className={styles.workColumn}>
          ...
          <div className={styles.workColumn}>
            <Link href="/issue4/isoline" passHref>
              <div className={styles.workLink}>
                ... evan isoline + as foam from this sweet hour ...
              </div>
            </Link>
          </div>
          <div className={styles.workColumn}>
            <Link href="/issue4/howfar" passHref>
              <div className={styles.workLink}>
                ... christa romanosky + how far you can get on an empty tank of
                gas ...
              </div>
            </Link>
          </div>
          <div className={styles.workColumn}>
            <Link href="/issue4/palacios" passHref>
              <div className={styles.workLink}>
                ... gabriel palacios + poems from lunar hilton elegy ...
              </div>
            </Link>
          </div>
          <div className={styles.workColumn}>
            <Link href="/issue4/hummel" passHref>
              <div className={styles.workLink}>
                ... allison hummel + the fires are back // i look at sauce //
          ...
          <div className={styles.workColumn}>
            <Link href="/issue4/poemsborn" passHref>
              <div className={styles.workLink}>
                ... vi khi nao + poems born from basic words ...
              </div>
            </Link>
          </div>
          <div className={styles.workColumn}>
            <Link href="/issue4/maierhofer" passHref>
              <div className={styles.workLink}>
                ... grant maierhofer + in the time when my memory fixated on the
        ...
        <div className={styles.issueDecor}>
          <div className={styles.titleAndSubtitle}>
            _ n e w + <br />s i n e w s _<br />
            <br />
            <span className={styles.subtitle}>issue _ 4</span>
          </div>
