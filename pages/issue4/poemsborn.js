...
export default function PoemsBorn() {
  return (
      <div>
          <Head>
            <title>vi_khi_nao ~ poems_born_from_basic_words — new_sinews</title>
       ...
       <br/>
        ...
        <RightGrayTitle><h4><span className={styles.titleShadow}>(</span> a time<span
          ...
          className={styles.titleShadow}> )</span></h4></RightGrayTitle>
...
<br/>
<pre className={styles.poem}>{`An angry air      above another
...
<br/>
<pre className={styles.poem}>{`Brave baby      bleeds
Between       beer   &  busy
...
<br/>
<pre className={styles.poem}>{`Obey ocean
Obey now
...
Open only for me, object`}</pre>
<br/><br/><br/><br/>
<h3 className={styles.sectionHeading}>Q</h3>
<br/>
<pre className={styles.poem}>{`Quiet queen
Quiet
Quiet
...
Quite the question
Quite the queen
Quite the quickness`}</pre>
<br/><br/><br/><br/>
<h3 className={styles.sectionHeading}>J</h3>
<br/>
<pre className={styles.poem}>{`Jump juice
Jump
Just jump
For jelly juice
Join us juice
...
<br/>
<pre className={styles.poem}>{`Noble noise
...
Now notice, noble noise, of my neck`}</pre>
<br/><br/><br/><br/>
<h3 className={styles.sectionHeading}>M</h3>
<br/>
<pre className={styles.poem}>{`Most mothers may marry  mistakes with medicine
