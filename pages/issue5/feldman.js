...
export default function Feldman() {
  return (
      ...
      className={styles.uppercaseFaintShadow}>l</span></span><br/><br/><span
      className={styles.faintShadowAncillary}>(or:<br/>e<span
      className={styles.alternateTitleColor}>i</span>gh<span
      className={styles.uppercaseAlternateTitleColor}>t</span><br/>stories)</span></RightGrayTitle>
         <LeftBlackTitle> ... jacqueline ... <br/> ... feldman ... </LeftBlackTitle>
      <br/>
      <RightGrayTitle><span className={styles.faintShadowAncillary}>co<span
      className={styles.uppercaseFaintShadow}>m</span>mi<span
      className={styles.uppercaseFaintShadow}>tt</span>m<span
      className={styles.uppercaseFaintShadow}>e</span>nt</span></RightGrayTitle>
      <StandardProse>
