...
export default function Feldman() {
  return (
      <div>
          <Head>
            <title>jacqueline_feldman ~ [] — new_sinews</title>
      ...
      <br/>
      <br/>
      <RightGrayTitle><h3 className={styles.title}>[]]</h3></RightGrayTitle>
      <RightBlackTitle><h3 className={styles.title}>jacqueline feldman</h3></RightBlackTitle>
      <br/>
      <StandardProse>
