...
export default function Bisagni() {
  return (
      <div>
          <Head>
            <title>paul_bisagni ~ nice_time_formula + jumbo_marvelous_domesticity_jilt + by_dint_of_
            little_else — new_sinews</title>
       ...
       <CenterBlackTitle>nice time formula // jumbo marvelous domesticity <br/>jilt // by dint of
       little else</CenterBlackTitle>
       ...
       className={styles.titleShadow}> i</span> ...</h3></CenterGrayTitle>
