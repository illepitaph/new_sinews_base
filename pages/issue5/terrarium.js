...
Terrarium.title =
  "vi_khi_nao + jessica_alexander ~ when_my_body_was_a_glass_terrarium — new_sinews";
Terrarium.pieceName =
  "vi_khi_nao + jessica_alexander ~ when_my_body_was_a_glass_terrarium — new_sinews";
Terrarium.description =
  "_Vi_Khi_Nao+Jessica_Alexander_poetry_WHEN MY BODY WAS A GLASS TERRARIUM_new_sinews_issue5_";
...
export default function Terrarium() {
  return (
    <>
      ...
      <RightGrayTitle>
        <span className={styles.inverseShadow}>w </span>
        <span className={styles.titleShadow}>h</span> e{" "}
        <span className={styles.inverseShadow}>n</span>
        <br />
        <span className={styles.inverseShadow}>my</span> <br />
        <span className={styles.titleShadow}>bo </span>dy
        <br />
        <br />
        <span className={styles.inverseShadow}>w</span>a
        <span className={styles.inverseShadow}> s</span>
        <br /> a <br />
        <span className={styles.inverseShadow}>g </span>l a{" "}
        <span className={styles.titleShadow}>ss</span>
        <br />
        <br />
        <span className={styles.titleShadow}>
          {" "}
          t <span className={styles.inverseShadow}>e </span>r
        </span>
        r <span className={styles.inverseShadow}>a</span>
        <span className={styles.titleShadow}> r </span>i
        <span className={styles.inverseShadow}>u </span>m
      </RightGrayTitle>
      ...
      <CenterGrayTitle>
        ::{" "}
        <span className={styles.titleShadowAlternate}>
          <i>vi</i>
        </span>{" "}
        ::
        <br />
        ...
        <span className={styles.inverseShadow}>+</span> jessica ::
        <br />
        ::{" "}
        <span className={styles.titleShadowAlternate}>
          <i>alexander</i>
      ...
      <pre className={styles.left}>
        {`The showerhead at 6AM `}
        <span className={styles.alternateVoiceOne}>{` lulls`}</span>
        <br />
        <span className={styles.alternateVoiceOne}>
          {`the  blue room  back to  sleep.`}
          {`   I  rolled
...
shaped lofts.`}
      ...
      <pre className={styles.left}>
        <span
          className={styles.alternateVoiceOne}
        >{`Back  when  I  feared  flying,  I’d  pretend`}</span>
        <br />
...
expanse      of  arctic      snow.`}
      ...
      <pre className={styles.right}>
        <span
          className={styles.alternateVoiceOne}
        >{`It  took  longer  on   the   drive to    Boulder`}</span>
        {`
...
focus.            `}
        ...
        {` aloud until we grew
bored   of  it.`}
        <span className={styles.alternateVoiceOne}>You wore </span>
        <span className={styles.alternateVoiceTwo}>{` a  dark  blue
wrap-around     dress     with      bell
shaped       sleeves    and      flower
print.      `}</span>
        <span
          className={styles.alternateVoiceOne}
        >{`You  wore a  special  skin-toned
bra    to    cover    up      the scar bisecting
your      chest.    At    our    apartment,      I
folded  you like`}</span>
        {`the stem of a flower
onto the bed.      `}
        <span className={styles.alternateVoiceOne}>{` Your neck smelled
salty &  floral.`}</span>
        <span
          className={styles.alternateVoiceTwo}
        >{`        You rested your left
hand     between    your      shoulder
and right  breast           `}</span>
        <span className={styles.alternateVoiceOne}>{`&  caught  your
breath.  You   did  this   the  first   night  we
lay together in a bed`}</span>
        {`    and my  body
turned to   you without moving.`}
      ...
      <pre className={styles.left}>
        <span
          className={styles.alternateVoiceTwo}
        >{`My   travel time home   `}</span>
        <span className={styles.alternateVoiceOne}>{`  from Boulder
back     to     Denver`}</span>
        <span className={styles.alternateVoiceTwo}>{`    has         greatly
diminished`}</span>
        <span
          className={styles.alternateVoiceOne}
        >{`,    in   hardship,     now   that
you`}</span>
        <span
          className={styles.alternateVoiceTwo}
        >{`    drive  to  campus  and collect
  me.`}</span>
        <span
          className={styles.alternateVoiceOne}
        >{` Thanks  to  your   tenderness,   my
teaching    days are   no   longer  as  long
nor     as      oxygen-deprived.    Teaching
behind  a  mask  is  a little       dangerous.
Even     my   student,    Sam,`}</span>
        {`      stops
breathing   when  reading  out
loud`}
        <span
          className={styles.alternateVoiceOne}
        >{`.   I  woke   early for   an    interview,
and`}</span>
        {`  oval spots of light traveled
up and down  my face   like  a
diurnal     flashlight.`}
        <span className={styles.alternateVoiceTwo}>{`      My  face
burst with luminosity like      bubble
wrap.`}</span>
        <span
          className={styles.alternateVoiceOne}
        >{`    Most    Fridays, you    are   busy
with  Zoom meetings.`}</span>
        {`      Your voice
echoes in our    loft-ish  abode
like    a  gramophone`}
        <span className={styles.alternateVoiceOne}>{`.    You   are
serious    and   friendly  and  I   fantasize;
I’d    like   to   do   something`}</span>
        {`      sultry
andscandalous`}
        <span className={styles.alternateVoiceOne}>{`behindyourlaptop`}</span>
        {`to
make you     smile.`}
        <span className={styles.alternateVoiceOne}>{`    The  thawed
out    frozen    pork    I        sauteed in red
sauce    and salt   had a         hemoglobin
       aftertaste,       and even the cabbage`}</span>
        <br />
...
palette transaction.`}
      ...
      <pre className={styles.left}>
        <span className={styles.alternateVoiceOne}>{`Last  night,`}</span>
        <span className={styles.alternateVoiceTwo}>{`    my  body  hung  like  a
glass terrarium;`}</span>
        <span className={styles.alternateVoiceOne}>{`  I felt  `}</span>
        {`   the soil of
your  fingers  beneath  me,   &
  the   water  of  my     orgasm
floating  in  between`}
        <span className={styles.alternateVoiceOne}>{`  each breath.
Everything in me was`}</span>
        {`     suspended
...
window. `}
        <span
          className={styles.alternateVoiceOne}
        >{` We   applied   for  jobs  in  a  glass
building   two stories  up  from   the  world  and
ate lunch outside`}</span>
        {`   and I was  tired and
...
grease,`}
        <span
          className={styles.alternateVoiceOne}
        >{`   and I    asked what you did for   fun
...
Switzerland.                                            `}</span>
      ...
      <pre className={styles.left}>
        <span
          className={styles.alternateVoiceOne}
        >{`Even  though  I  took  only`}</span>
        <span className={styles.alternateVoiceTwo}>{`    one  sip of `}</span>
        <br />
        {`the  Bread  and   Butter   wine`}
        <br />
        <span className={styles.alternateVoiceOne}>{`you    bought,`}</span>
        <span
          className={styles.alternateVoiceOne}
        >{`   I  woke    feeling  as  if    I
had    a   hangover.`}</span>
        {`       We   fought
intensely last night`}
        <span className={styles.alternateVoiceOne}>{`             with me
saying many    fucks.`}</span>
        {`   In the middle
of  the  fight,`}
        <span className={styles.alternateVoiceOne}>{`   you       climbed out of
bed.`}</span>
        {`   I  could  hear   you in the
darkness, `}
        <span
          className={styles.alternateVoiceOne}
        >{`    putting on a   t-shirt and
pants.`}</span>
        {`     I could hear the sonic,
...
bag up and began another.`}
        <span className={styles.alternateVoiceOne}>{`    i
...
and know`}
        <span
          className={styles.alternateVoiceOne}
        >{` and   so   I   did    not  want to go.`}</span>
      </pre>
...
began filtering through`}
        <span className={styles.alternateVoiceOne}>{`    and we
...
to exist than to not.`}
        <span className={styles.alternateVoiceOne}>{`   He said `}</span>
        {`  if
they`}
        <span
          className={styles.alternateVoiceOne}
        >{`    (the   fallen   angels,   including
Satan)`}</span>
        <span
          className={styles.alternateVoiceTwo}
        >{`   irritate  God too  much, he
might   obliterate  them.`}</span>
        <span className={styles.alternateVoiceOne}>{`   The  most
egregious     thing     they     could      do
(revenge-wise)  was`}</span>
        {`    to   “disturb”
and     “alarm”     GOD,`}
        <span className={styles.alternateVoiceOne}>{`        but`}</span>
        <br />
        <span
          className={styles.alternateVoiceTwo}
        >{`otherwise,    God   is   God.`}</span>
        <span className={styles.alternateVoiceOne}>{`   Belial
suggested   that`}</span>
        {`   "familiarity  with
...
grown.`}</span>
        <span
          className={styles.alternateVoiceTwo}
        >{`   And,  he  raped  her.  And,
when   he   raped  her,  she  gave
birth  to  Death,  their  son.`}</span>
        <span className={styles.alternateVoiceOne}>{`      And,
their    son,    Death,    inspired    by  his
father’s  genetic   gene  pool  of      rape,
raped his mother, Sin.`}</span>
        {`    Back then,
you said,  people didn’t know
how   to   fuck.`}
        <span className={styles.alternateVoiceOne}>{`  There were limited
orifices.  And,  they  only  knew  how  to
rape.`}</span>
        {`   Mary was   a victim   of
such. `}
        <span
          className={styles.alternateVoiceOne}
