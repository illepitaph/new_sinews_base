...
import styles from "../../styles/Moore.module.css";
Moore.title =
    ...
    <>
      ...
      <CenterBlackTitle>
        <span className={styles.titleShadow}>
          ...
          <span className={styles.uppercase}>a</span>d
          <br />
          <br />
          <br />
          fri<span className={styles.uppercase}>e</span>nds // zo
          <span className={styles.uppercase}>n</span>e ++{" "}
          <span className={styles.uppercase}>a</span>psid
          <span className={styles.uppercase}>a</span>l // poe
          <span className={styles.uppercase}>m</span> <br />
          <br />
          <br />
          fo<span className={styles.uppercase}>r</span> w
          <span className={styles.uppercase}>al</span>ter benj
          <span className={styles.uppercase}>a</span>min ++ so
