  ...
  return (
      <>
       ...
       <Header headerBackground="stoughBackground"/>
        ...
        <br/>
        <br/>
        I wake up and I have decided I need to relearn to walk. I take a walk through Watertown
        using a technique I fashioned from the words of Pauline Oliveros, her practices. A deep
        listening exercise. Both an exercise in deep listening and exercise. How could I lose? How to open
        the door to music rather than the all too common refrain.
        <br/>
        <br/>
        <br/>
        I take a walk using a technique I fashioned from words. Pauline Oliveros. A deep listening.
        Both an exercise and exercise. How could I lose? How to open the door rather than the all too
        all too. Simple: by paces left open to exchange.
        <br/>
        <br/>
        <br/>
        A few simple rules:
        ...
        <br/>
        <br/>
        1) Enter a meditative state such that requires one to stare forward a few feet from one’s body,
        and not to move one’s eyes.
        <br/>
        <br/>
        <br/>
        2) Establish a pace, of breathing and stepping. They don’t need to be identical. They will become
        identical (effectively).
        <br/>
        <br/>
        <br/>
        3) Listen to Pauline Oliveros’ 1982 composition <cite><span className={styles.grayShadow}>Horse Sings from
        The Cloud </span></cite> (not loudly, at ‘conversational’ pitch) through earbuds connected to a player.
        <br/>
        <br/>
        <br/>
        4) Think of a destination and go there. Instead of thinking of the many steps it will take to reach
        the destination, think of the trajectory from home door to destination as one organic movement, like
        the single bound. Refrained time (there is no other kind of time) tells us where (when) a territory
        should end, yet by this exercise we seek to push the abstract boundaries of both territory and time,
        angling a longer pass.
        <br/>
        <br/>
        <br/>
        A few simple rules, through Watertown. A walk I fashioned from the words of Pauline Oliveros. A deep
        listening exercise. Both an exercise in deep listening and exercise. I need to relearn—how to walk, listen,
        invite—and the only way is to move my legs out the door, but also to will something return. Like a baby’s
        climb to deictic. I mean <i>this</i> moon and star. My legs.  By eliminating, somewhat, the necessity to see, I
        shift walking’s intensive calibration away from the day to day and toward something like an experiment.
        A hair-pin adjustment. Just by a hair. A helicopter on Mars. I make walking an intensive collaboration
        between the step and the breath, which—once I begin—realize how different a song this twining has made.
        A longer field. Toward something like an experiment, a practice, an <i>ethico-aesthetic</i> because I embody
        ways of living, the myriadic repetition of (good) deleture. As always, following Nietzsche through Turin.
        <br/>
        <br/>
        <br/>
        Much like the various “filters” available for use on social media, often one begins again after a trial in
        which the possibilities make themselves known, and then one selects, and then one experiments, or the experience
        comes from earlier. So I began the exercise, effectively, after I had really begun. This had implications for
        the song of which I’m proud, and implications for guilt. I become aware of a light-relation between beings,
        not a sound relation, and not even truly a sight relation. This had something to do with the hum between my
        ...
        <br/>
        <br/>
        Affect sticks, expressed and contented. For a while I can resist. At the first intersection, only, I edge
        a refrain from the rigidity my spine assumes crossing the rectangles (the crosswalk), themselves placed
        in an echo of pond stones, affording only one plane of crossage. I took molar safety for granted, thought
        luckily nothing had mowed me down as I emerged as from a lake onto the other side of the street.
        <br/>
        <br/>
        <br/>
        I had chosen the water, that is the bridge on the water, or the water sufficiently itself. To be honest
        I hadn’t decided. My destination. No more like numbering. Though a decision has to be made, no decision
        in this scenario survives. Therefore, one not only should remember to improvise, but what forms improvisation
        might take in relation to the here/now.
        <br/>
        <br/>
        <br/>
        Instead of thinking of the many steps it will take to reach the destination, think of the trajectory from home
        door to destination as one organic movement, like the single bound. I had chosen the water, that is the bridge
        on the water, or the water sufficiently to itself. I didn’t need to decide. I took molar safety for granted.
        I could walk in a direction with no direction. I think of how conversational speech typically sticks to one pitch,
        one volume, though the speakers vary. The body leans where it needs to. I try not to worry about people. In
        the world. I worry about people on my phone. I walk bloomingly but I wouldn’t want to run into anything
        (relatively), so I follow, in a very limited sense, the blurry line of the sidewalk through my meditated eyes.
        <br/>
        <br/>
        <br/>
        ...
        mechanism has structure, where the machine finds a connection (or is a found connection—a <i>sound</i> connection).
        A sound connection, like structural integrity of a bridge or the bird refrain, located in speech, the chatter of cats,
        Debussy’s <span className={styles.grayShadow}><i>Preludes</i></span> . My foot as it moves in and out of step with
        itself, in and out of the drone. The single bound, with all its little tiny decisions. Every friend unfolds like
        the pressure of my hand in a fountain. I walk for <i>them</i>, the t-shirt reads.
        <br/>
        <br/>
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        Affect, affect, affect… As in between opposition, between the beat and the step. Which is subjective, and that
        wants an object? Which encounters the scan?
        <br/>
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        This morning I stood in my living room between her desk and the couch and lifted my arms until they touched,
        then brought them down—hands in prayer—to the level of my heart, exhaling.
        <br/>
        <br/>
        <br/>
        ...
        className={styles.grayShadow}><i>money</i></span>, which is not not its negation. Alm-ost in <span
        className={styles.grayShadow}><i>own</i></span>, whose ghost haunts all of it. Our living together. Our
        root in others. In various contexts.
        <br/>
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        Four simple rules. I think of home in these moments of peace. That is, I think of the indissoluble space
        between objects in one’s typical field of vision, how that shapes one’s habit of expectation. Affect: a
        habit of expectation, the limit of what can be felt. As only the felt can be felt. Only the refrain, by
        opening to another, allows for the true, unrepresented possibility for change. Yet back in Missouri, all
        the existential refrains ever say is “Don’t kill me.” Hills going into the sky, then back down, down. Not
        knowing if the car on the other side of the hill driving the opposite way has drifted into the center lane
        or not, a constant game of chicken, except un-incentivized. Exhale. Massachusetts. Watertown. Lexington.
        Street. Charles River. Exhale. Parkway. Charles River. The sound of the ducks only audible when I opened my
        eyes to their little feet paddling. Exhale.
        <br/>
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        Resuming the exercise in a period of great anxiousness. Hoping it doesn’t stick around, that this mood could
        turn into a diagnosis. I walk to the library in heat. I amble. It’s good that I’ve made this walk—like the
        one to the river—at least fifty times in the past year alone. I don’t have to <i>think</i>, no-nonsense
        conceptual-walk.
        <br/>
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        Calming down—de-escalating—this isn’t “my thing.” But I can (<span
        className={styles.grayShadow}><i>Write it!</i></span>). I blazon. The one huge tattoo of my chest on my chest.
        <br/>
        <br/>
        <br/>
        This morning I’ll try walking among my territory in order to reach, perhaps, what lies behind it. I don’t know.
        I begin walking. Much like in the months following my father’s passing, entering the meditative state ignites
        an outpouring of grief. The sensei used to say, “If you must cry, the books have taught us, you must cry with
        the full outpouring of your grief.” What about a grief that isn’t your grief. I think of Emerson, as I often
        think of Emerson. Do I escape into Pragmatism itself as a refuge, or is my nature inherently pragmatic,
        admittedly most visible amidst strife? That I find personal import in the pragmatic method seems less
        suitable to the discussion here than that I’m typically miserable. I carry strife like a weaponous limb, it’s
        true. What a machine I miraculate. It seems to be just the room that I’m in that affects me so. The same room.
        Or series of empty rooms. As I’ve gathered, there’s nothing more painful than a series, that which is said to
        be operating, that which one must lend care. It’s why I’ve never kept a garden.
        <br/>
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        I wouldn’t want to run into anything. (Relatively). So I follow, in a very limited sense, the blurry<br/>line of<br/>
        ...
        Sometimes a depth is the surface. I wend as a snake wends, dark with the coming.
        <br/>
        <br/>
        <br/>
        Conscious of the thick penis failing to latch onto my left thigh as I step, lifting in near but never perfect
        tandem, the body’s third wheel. And first anchor. Conscious of the non-will to always be pulling it out of my
        pants. Action that miraculates the body beneath.
        <br/>
        <br/>
        <br/>
        I think possibly it gets in the way of too much. “From a certain point of view, it would be much better if
        nothing worked, if nothing functioned. Never being born, escaping the wheel of continual birth and rebirth, no
        mouth to suck with, no anus to shit through...”
        <br/>
        <br/>
        <br/>
        Not always conscious of the stiffness all over. Waking up to do stretches. Waking up to do work. Shitting and
        eating. Fucking and singing.
        <br/>
        <br/>
        <br/>
