...
Issue3.description =
  "_newsinews_issue3_Vi Khi Nao+Cary Stough+Sara Deniz Akant+Steven Alvarez+Megan Jeanne Gette+Kelly Krumrie+Shome Dasgupta+Mike Corrao_";
Issue3.image = "https://www.newnewsinews.com/images/Issue3CoverScreen.jpg";
          ...
          <div className={styles.issueContents}>
            <div className={styles.workColumn}>
              <Link href="/issue3/dusk" passHref>
                <div className={styles.workLink}>
                  vi khi nao_retrieve the dusk
                </div>
              </Link>
            </div>
            <div className={styles.workColumn}>
              <Link href="/issue3/stough" passHref>
                <div className={styles.workLink}>cary stough_balance sheet</div>
              </Link>
            </div>
            <div className={styles.workColumn}>
              <Link href="/issue3/akant" passHref>
                <div className={styles.workLink}>
                  sara deniz akant_how t langed
                </div>
              </Link>
            </div>
            <div className={styles.workColumn}>
            ...
            <div className={styles.workColumn}>
              <Link href="/issue3/krumrie" passHref>
                <div className={styles.workLink}>
                  kelly krumrie_excerpts from ‘no measure’
                </div>
              </Link>
            </div>
            <div className={styles.workColumn}>
              <Link href="/issue3/dasgupta" passHref>
                <div className={styles.workLink}>
                  shome dasgupta_remember nothing
                </div>
              </Link>
            </div>
            <div className={styles.workColumn}>
