...
Issue3Bios.image = "https://static1.squarespace.com/static/5b78c5275ffd20862324ad8e/t/622a4c8d8249442d34b49b5d/1646939277961/ArchNewSinew.jpg"
...
export default function Issue3Bios() {
  ...
  <>
   ...
   <CenterGrayTitle><span className={styles.magicMint}>issue_3</span></CenterGrayTitle>
   ...
   </cite>(Orson&apos;s Publishing); two plays, <cite><strong>Smut-Maker</strong></cite> (Inside the
   Castle) and <cite><strong>Andromedusa</strong></cite> (Forthcoming - Plays Inverse); and two
   chapbooks, <cite><strong>Avian Funeral March</strong></cite> (Self-Fuck) and <cite><strong>Spelunker</strong></cite> (Schism
