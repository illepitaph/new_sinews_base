...
export default function Taylor() {
  return (
      <div>
          <Head>
            <title>sam_taylor ~ five_poems — new_sinews</title>
            <meta charset="utf-8"/>
       ...
       <LeftGrayTitle><h3>sam <i>taylor</i></h3></LeftGrayTitle>
       <LeftBlackTitle><h3>five <i>poems</i></h3></LeftBlackTitle>

       <LeftGrayTitle><h3>[ dancing of our own erasure ]</h3></LeftGrayTitle>
  ...
  while feeling quicker stole—lightning from the blue—
    ...
    <LeftGrayTitle><h3>[ revision ]</h3></LeftGrayTitle>
    ...
    <StandardLineation content={`
      ...
      <LeftGrayTitle><h3>[ return ]</h3></LeftGrayTitle>
      ...
      <StandardLineation content={`
        ...
        <LeftGrayTitle><h3>[ if you find some shard of lost knowledge write it
          down. if you find it written down, bury it ]</h3></LeftGrayTitle>
          ...
          <StandardLineation content={`
            ...
            <LeftGrayTitle><h3>[ the book of runes, part VI ]</h3></LeftGrayTitle>
