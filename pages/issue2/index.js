...
Issue2.description =
  "_newsinews_issue2_Susan Briante+Mike Corrao+Felicia Zamora+Sam Taylor+Rebecca Ariel Porte+Susan Lewis+Babak Lakghomi+Vi Khi Nao+Adam Strauss+Brandon Shimoda_";
        ...
        <div className={styles.pageStructure}>
          <div className={styles.titleAndSubtitle}>
            ...
            <div className={styles.issue}>
              <span className={styles.inverseTitleColor}>i</span> s{" "}
              <span className={styles.inverseTitleColor}>s</span> u{" "}
              <span className={styles.inverseTitleColor}>e</span> _{" "}
              <span className={styles.inverseTitleColor}>2</span>
            </div>
          </div>
          ...
          <div className={styles.issueContents}>
            <div className={styles.col1}>
              <Link href="/issue2/briante" passHref>
                <div className={styles.workLink}>susan briante_two poems</div>
              </Link>
            </div>
            <div className={styles.col1}>
              <Link href="/issue2/zamora" passHref>
                <div className={styles.workLink}>
                  felicia zamora_selections from &apos;quotient&apos;
                </div>
              </Link>
            </div>
            <div className={styles.col1}>
              <Link href="/issue2/taylor" passHref>
                <div className={styles.workLink}>sam taylor_five poems</div>
              </Link>
            </div>
            <div className={styles.col1}>
            ...
            <div className={styles.col1}>
              <Link href="/issue2/strauss" passHref>
                <div className={styles.workLink}>adam strauss_five poems</div>
              </Link>
            </div>
            <div className={styles.col1}>
            ...
            <div className={styles.col2}>
              <Link href="/issue2/lewis" passHref>
                <div className={styles.workLink}>susan lewis_two poems</div>
              </Link>
            </div>
            <div className={styles.col2}>
              <Link href="/issue2/lakghomi" passHref>
                <div className={styles.workLink}>
                  babak lakghomi_a request + say her name
                </div>
              </Link>
            </div>
            <div className={styles.col2}>
              <Link href="/issue2/leyeaste" passHref>
                <div className={styles.workLink}>vi khi nao_le yeaste</div>
              </Link>
            </div>
            <div className={styles.col2}>
            ...
            <div className={styles.siteShortcuts}>
              <button className={styles.linkButton}>
                <div className={styles.innerSiteLinkTag}>
                  <Link href="/" passHref>
                    ➜ new sinews ➜
                  </Link>
                </div>
