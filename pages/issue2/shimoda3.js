...
TombModelThree.title =
  "brandon_shimoda ~ don't_forget_that_for_now_it's_strawberry_season_yes._ — new_sinews";
TombModelThree.pieceName =
  "brandon_shimoda ~ don't_forget_that_for_now_it's_strawberry_season_yes._ — new_sinews";
TombModelThree.description =
  "_don’t forget that for now it’s strawberry season. yes_Brandon Shimoda_new sinews_issue2_";
TombModelThree.image = "https://www.newnewsinews.com/images/TombBackground.jpg";
  ...
  return (
    <>
      <Head>
        <title>
          brandon_shimoda ~
          don&apos;t_forget_that_for_now_it&apos;s_strawberry_season_yes._ —
          new_sinews
        </title>
