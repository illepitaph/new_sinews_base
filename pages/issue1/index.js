...
Issue1.description =
  "_newsinews_issue1_Sarah Gridley+Tongo Eisen-Martin+Gabriel Blackwell+Christa Romanosky+Vi Khi Nao";
Issue1.image = "https://www.newnewsinews.com/images/Issue1CoverScreen.jpg";
          ...
          <div className={styles.issueContents}>
            ...
            <div className={styles.col1}>
              <Link href="/issue1/gridley" passHref>
                <div className={styles.workLink}>
                  sarah gridley_poems from _insofar_
                </div>
              </Link>
            </div>
            <div className={styles.col1}>
              <Link href="/issue1/blackwell" passHref>
                <div className={styles.workLink}>
                  gabriel blackwell_scenery + bedtime
                </div>
              </Link>
            </div>
            <div className={styles.col1}>
            ...
            <div className={styles.col2}>
              <Link href="/issue1/nao" passHref>
                <div className={styles.workLink}>
                  vi khi nao_2 eyes in 1 eye: a delirium
                </div>
              </Link>
            </div>
            <div className={styles.col2}>
              ...
              <Link href="/issue1/bios" passHref>
                <div className={styles.workLink}>~~~b i os ~~~</div>
              </Link>
            </div>
