...
Eisen_Martin.description =
  "Tongo Eisen-Martin_2 Poems_FISH WITH AMBITION TO BECOME THE RIVER+TWO NIGHTS ON 16TH STREET_new_sinews _issue1_";
Eisen_Martin.image =
  "https://www.newnewsinews.com/images/EisenMartinBackground.jpg";
  ...
  return (
    <>
      ...
      <div className={styles.poem}>
        ...
        <p className={styles.leftJustified}>
          Talking head says, “go to sleep children. You will all be police
          tomorrow.”
        </p>
        <p className={styles.leftJustified}>We say: No. We will be the poor.</p>
        <p className={styles.leftJustified}>
          Talking head says, “ok scumbags, I talked to you like children; now
          you will be dogs”
        </p>
        <p className={styles.leftJustified}>
          “Market Street” is the best two-word joke I have ever heard in San
          Francisco
        </p>
        <p className={styles.leftJustified}>
          “Now I have to teach myself how to pass out sketches and throw pencils
          at pigeons when I retire”
        </p>
        <p className={styles.leftJustified}>
        ...
         
        <pre
          className={styles.standardLineation}
        ...
        <p className={styles.leftJustified}>
          “now I have to put charcoal under the classroom and do impossible
          things with tap water”
        </p>
        <p className={styles.leftJustified}>
          “leave the window open so that the most respectful rats will come in
          and white enlightenment will have something to ponder.”
        </p>
        ...
        <p className={styles.leftJustified}>
          Pathology needs a god to represent it to children and child-like
          states
        </p>
...
`}</pre>
        <p className={styles.leftJustified}>
          Class betrayal gone glassless // I mean ironically // my window
          started fogging over too
        </p>
