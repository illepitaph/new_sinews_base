...
Desire.description =
  "_XIAO YUE SHAN_poetry_THE DICTIONARY OF DESIRE_new_sinews_issue6_";
...
export default function Desire() {
  return (
    <>
      ...
      <LeftGrayTitle>
        <span className={styles.mintShadow}>
          ... <span className={styles.silverShadowUpper}>t</span>
          <span className={styles.grayShadow}> h</span>{" "}
          <span className={styles.inverse}>e ... </span>
          <span className={styles.silverShadow}>d</span>{" "}
          <span className={styles.inverse}>
            <i>i</i>{" "}
          </span>{" "}
          c<span className={styles.silverShadowUpper}>T </span>
          <span className={styles.grayShadow}>
            <i>i</i>{" "}
          </span>
          <span className={styles.silverShadow}>o</span>
          <span className={styles.inverseUpper}>
            <i>n</i>{" "}
          </span>
          <span className={styles.mintShadow}>a </span>
          <span className={styles.silverShadowUpper}>r </span>
          <span className={styles.inverseUpper}>y </span> ...{" "}
        </span>
      </LeftGrayTitle>

      <RightGrayTitle>
        <span className={styles.grayShadow}>
          <span className={styles.silverShadowUpper}>_</span>
        </span>
        <span className={styles.mintShadow}>
          {" "}
          o
          ...
          _ <br />
          <br />
          <br /> <span className={styles.grayShadow}>... </span>
          <span className={styles.silverShadow}>d</span> e{" "}
          <span className={styles.silverShadowUpper}>s </span>
          <span className={styles.inverse}>i </span>
          <span className={styles.silverShadowUpper}>r </span>
          <span className={styles.inverseUpper}>e</span>{" "}
      ...
      <pre className={styles.poem}>
        <span className={styles.boldHeader}>horizontals—</span>
        <br />
...
`}
        <span className={styles.boldHeader}>causality—</span>
        <br />
...
`}
        <span className={styles.boldHeader}>fiction—</span>
        <br />
        <i>the knowledge of green is told in the language of trees</i>
...
`}
        <span className={styles.boldHeader}>heaven—</span>
        <br />
...
`}
        <span className={styles.boldHeader}>chorus—</span>
        <br />
...
a dark pulsing morse of yes. I ran, yes I `}
        <i>ran</i>
        {`, towards the cannibal light breaking
teeth on the day, like fire struggling to be born under all that continent, all

`}
        <span className={styles.boldHeader}>extent—</span>
        <br />
...
`}
        <span className={styles.boldHeader}>free—</span>
        <br />
...
inner nods of elbows. how my body learned the language of desire. word by`}
      </pre>
      <br />
      <br />
      <br />
