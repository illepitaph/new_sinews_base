...
Griffin.title =
  "brandan_griffin ~ wolly_a_walnut_talks_anotherwhere — new_sinews";
Griffin.pieceName =
  "brandan_griffin ~ wolly_a_walnut_talks_anotherwhere — new_sinews";
Griffin.description =
  "_BRANDAN GRIFFIN_poetry_WALLY A WALNUT TALKS ANOTHERWHERE_new_sinews_issue6_";
  ...
  return (
    <>
      ...
      <CenterGrayTitle>
        ...
        <span className={styles.titleShadow}>o</span>{" "}
        <span className={styles.mintAlternate}>ll</span>
        <span className={styles.inverseShadowAlternate}> y</span> <br />
        <br />
      </CenterGrayTitle>
      ...
      <RightGrayTitle>
        ...
        <span className={styles.inverseShadow}>a</span>
        <span className={styles.mintAlternate}>l </span>
      ...
      <CenterGrayTitle>
        ...
        <span className={styles.inverseShadow}>
          a<span className={styles.mintAlternate}>l</span>{" "}
        </span>
        <span className={styles.titleShadow}>k s</span>
      </CenterGrayTitle>
      ...
      <LeftGrayTitle>
        <span className={styles.inverseShadow}>a </span>
        <span className={styles.titleShadow}>n </span>
        ...
        <span className={styles.inverseShadowAlternate}>
          e <span className={styles.inverseShadow}>r </span>
        </span>
        <span className={styles.mintAlternate}>
          wh<span className={styles.inverseShadowAlternate}>er</span>e
        </span>
      </LeftGrayTitle>
      ...
      <RightBlackTitle>
        <span className={styles.bareHeader}>... brandan ... griffin ...</span>
      </RightBlackTitle>
