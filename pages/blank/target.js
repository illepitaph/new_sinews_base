...
export default function Target() {
  return (
    <>
      ...
      <br/>
      <br/>
      After visiting home, or perhaps a little prior, a steady off-ness had built in me a fortress until I awoke one
      morning to N.’s startled face in my own. An $850 trip to the emergency room and I’m reminded that panic only
      recedes by great effortlessness, where the story begins, where the will automates the rush of action
      inconclusively, though operative.
      <br/>
      <br/>
      <br/>
      ...
      <br/>
      <br/>
      The sensory. What feedbacks the senses senses a route backwards toward a second, personalogical recognition where
      everything is a cathedral built by wisps of past effort. Like the old fashioned telephone, we can’t surmise
      its mechanical properties other than the prosthetic use once crossed with the human-divinity plane, where <i>the</i> human is immortal.
      <br/>
      <br/>
      <br/>
      For example
      ...
      <br/>
      <br/>
      In Charlestown, I held her hand through the streets I was seeing. I was seeing seeing the streets as if the streets
      were a castle built by refractions in the door frame. Even the Monument seemed like something I’d placed there, poking
      my own eye (not the atmosphere).
      <br/>
      <br/>
      <br/>
      I was hearing hearing the people streaming aboard Old Ironsides. I held my face in the mist near the old courts. I felt
      hers. My legs promptly gave in to a pain I didn’t register as my own.
      <br/>
      <br/>
      <br/>
      ...
      the objective essence as evidence of it being a symptom of some other unity, thus abandoning it. Spinoza, on the
      other hand, is the one who knows that it is precisely the infiltrative presence of these other “unities” that keeps
      us from focusing on this ever-unwanting task at hand, human freedom.
      <br/>
      <br/>
      <br/>
      Oscillation inaugurates—sets going—not the recognition of oneself, but the howl. “If you want to drive a person
      crazy…” Alan Watts wants a bowl of.
      <br/>
      <br/>
      <br/>
      The howl. We listen to the music of a certain part of our youth we desire to never leave. This is what is meant
      by a ‘black hole.’ As Keith Reniere used to ask his followers, “What do you lose if you were to stop living
      ...
      <br/>
      <br/>
      I worry worrying. I see myself seeing worrying. Fearish and trembling, sun through the white blinds, from
      the white wall a reflection of tan on the bedsheets I kept kicking. My bloating, the keep. The most important
      thing to consider now now under consideration, unable to ‘let go.’ Become-Kleist. The puppet coming over
      the master like shadows of an air raid. We must, first of all, recover belief in this world.
      <br/>
      <br/>
      <br/>
      ...
      <br/>
      <br/>
      With certain drugs, there are no second chances. Or easy ones. I suppose we could have induced ourselves to expel
      the moulded shrooms. She did vomit, later, after nearly choking on a piece of bread.
      <br/>
      <br/>
      <br/>
      I was introduced to Lord of the Dance. The day had been planned to be a day of working on the internet. We’d
      driven to Southie to pick up a printer/scanner that didn’t print. Later, its sleek modern design features would
      to us look like the idiosyncratic mouth of Evil, and we treated it so.
      <br/>
      <br/>
      <br/>
      The rain had stuck us inside like two pairs of sandals. I had no inclination to have sex. This was the first time
      I’d felt attacked by routine. We just sat on the couch, occasionally becoming looped. In each other’s orbits was
      a profligate wasting-away of one’s presentness, and not even the music winding through the apartment could bring
      us any closer to the bliss we’d encountered down the Cape on some beach of which we no longer even remember
      the name: eating a whole bag of chips, nearly pissing to keep warm, but rolling through the atmosphere with
      a serpent’s muscle, hearts real. A woman came up to the shack in which we were holed only to put a letter
      ...
      <br/>
      <br/>
      Aim sight. From Berryville on down, one sees into a past that’s stuck around. These mid-Cambrian hills referred to
      as mountains, valleys so far below sea-level your ears pop just ascending a stair. N. begs to take a picture in
      front of the vintage Coca Cola mural. Rolled deep into tourist country. Just before crossing the Line, N. gets
      out to piss behind an empty church. I snap a picture unsure of whether CVS will develop graven images such as
      this, her ass popping out from beneath her blouse in the familiar but always shocking bone-shade bone-shape. We’re
      headed to Eureka, land of so many ancestors, aesthetic and real. Touted as “my favorite place on planet Earth,” and
      I stand by that.
      <br/>
      <br/>
      <br/>
      AKA: Little Switzerland. Two Dutch Dames Chocolate Shoppe. History of Klan activities, history of Wiccan
      activities, history of Osage displacement, history of World War I. In Carroll County, the old places like
      this. A movie set sans camera crew. Few know of it, though those who do, assured of its dark, dank mystery, acclaim it.
      <br/>
      <br/>
      <br/>
      I’d put “Eureka Springs” on the agenda as an open-ended prompting, for exploration. I’d already filled N. in on
      most of the lore—historical, that which precedes me, and my own—such as the haunted Crescent Hotel, the Bourbon St.
      Inn, where Stanford stayed initially when he blew into town white-suited. Any mention of the poet brings to mind
      lines from C.D. and the image of how I suspect .22 holes in a chest would look. As if nothing entered the body
      at all. Negative pimples erupting inward. They say, it’s the force of its trajectory, as well as the swiftness
      with which lead keel-hauls a biological system, that kills the idiot who uses such a small caliber weapon.
      <br/>
      <br/>
      <br/>
      We sweat into our shorts, the dinky shop-lined streets where both my parents and my mentors (C.D. and Forrest) undoubtedly
      strolled, post-coitus in new marriage bliss. A honeymoon destination. The first city in Arkansas to issue marriage
      licenses to “queers.” An LGBTQ destination solely based on its being the center around which migration falls, a town
      no one really wants to visit for more than a day, unless you’re in love with each other or God. In the magic shop, the
      kid asks us if either of us know how to skateboard. In the gallery, the man asks us if we know the work of Thomas
      Kinkade. Of-fucking-course we do, we think.
      <br/>
      <br/>
      <br/>
      ...
      <br/>
      <br/>
      Incidentally, this is the location of C.D. and Forrest’s vows. Poets as speech-actors. Reading the pamphlet in pew I
      recognize the fact that the two must have been one of the first couples wedded here, perhaps just a year after its opening.
      <br/>
      <br/>
      <br/>
      ...
      sense blameworthy, though through misreadings of their work, undoubtedly. No doubt still to blame. Though comportment (as
      in, repetition is a comportment, from the first page of <span
      className={styles.grayShadow}><i>Difference and Repetition</i></span>). A position: that’s how it’s felt
      with N. I’m held by a love that has nothing of a beginning or end. Truly as if I came in at the middle, clambering
      through the orchestra pit and onto the stage, the audience full in its emptiness.
      <br/>
      <br/>
      <br/>
      On the long drive home (as always, I mistakenly turn onto 13 instead of continuing through Branson West to 160, resulting
      in a much longer trek through the old country, where the old people lived their deaths) mom calls to tell us dinner
      won’t be ready. “I have no energy,” she says, “I’ve been in the ER with Granny all day.” Last night, apparently, Granny
      downed an entire bottle of Lovenox, an anticoagulant. At her age, I assume, there’s not much blood to thin beneath
      such brittle skin. A thin place. Frantic, I grip the wheel. “She’s alright. The doctor says she can leave
      tomorrow. Nothing happened.” Nothing happened. One more thing: “When I told her this is why she needs
      someone to watch over her—because she took all of her pills by mistake—she tells me ‘Maybe I did it
      on purpose, did you ever think of that?’”
      <br/>
      <br/>
      <br/>
      “Maybe I don’t want to live anymore.” Not ‘maybe I want to die,’ an exhaustion of what’s possible. Maybe I
      don’t want to live anymore, maybe life doesn’t want me. This proliferation of dead cells. I carry around
