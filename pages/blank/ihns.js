...
export default function Ihns() {
  return (
    <>
      ...
      <CenterBlackTitle><span className={styles.titleShadow}><i>wulv // hickory // the heaven of knitwear // art
      <br/><br/><br/>class // survival of the smile of the cheshire <br/><br/><br/>cat // the simplest case of participation</i></span></CenterBlackTitle>

      <br/>
      <br/>
      <br/>

      <RightGrayTitle><span className={styles.inverseNameShadow}>k<span
      className={styles.mintAlternate}>i </span><span
      className={styles.nameShadow}>r</span>-<br/><br/>s<span
      className={styles.mintAlternateUppercase}>t</span><i>e</i> <span
      className={styles.nameShadow}><i>n</i></span></span><br/><br/><span
      className={styles.mintAlternate}>i </span><span
      className={styles.inverseNameShadow}>h </span><span
      className={styles.nameShadow}><i>n </i></span><span
      className={styles.inverseNameShadow}>s</span></RightGrayTitle>
...
Edible on the ground`}</pre>
      ...
      <h3 className={styles.poemTitle}>survival of the smile of the cheshire cat</h3>
...
the facts are constantly about me`}</pre>
      ...
      <br/>
      <pre className={styles.poem}>{`Karma, the huge dog, takes a shit in the grass
