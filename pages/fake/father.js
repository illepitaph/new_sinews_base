    ...
    <>
      ...
      <LeftGrayTitle>
        <span className={styles.titleShadow}>
          ...
          <br />
          <br />_<span className={styles.inverseShadow}>f</span> i
          <span className={styles.alternateTitleColorBigger}>g</span>
      ...
      <div className={styles.authorName}>
        {" "}
        <span className={styles.ellipses}>...</span> andrea <br />{" "}
        <span className={styles.ellipses}>...</span>harper{" "}
      </div>
      <br />
      <br />
      <br />
      ...
      <StandardProse>
        ...
        <br />
        <br />
        Soon after Kept_Male and PhoneBaby21 met, she disappeared for two weeks.
