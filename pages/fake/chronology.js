  ...
  return (
    <>
      ...
      <StandardProse>
        ...
        <br />
        <br />
        <span className={styles.specialCursiveThree}>2019</span>By now Los
        Angeles has become a derelict, neon-soaked metropolis. Vehicles are
        airborne. People still read magazines. Those who can afford to have
        abandoned Earth for far-flung colonies. A private corporation has
        manufactured a fleet of androids to service their human overlords. They
        have a battery life of four years to limit their ambitions and keep them
        meek. But a faction of these robots has gone rogue. <i>Father</i>,{" "}
        <i>fucker</i>, <i>we want more life</i>.
        <br />
        <br />
        <br />
        <br />
        ...
        <br />
        <br />
        <span className={styles.specialCursiveThree}>2021</span>The most secure
        way to transfer large amounts of sensitive data is by downloading the
        information directly into the brains of so-called mnemonic couriers, who
        make room for these gigabytes by removing large chunks of their personal
        memories. Much of the world’s population now suffers from a neurological
        condition known as NAS, or Nerve Attenuation Syndrome. Also known as the
        “Black Shakes,” the disease is caused by overexposure to technology; the
        people who have it seize uncontrollably. Newspapers still exist.
        Mega-corporations rule society, protected by hired Yakuza. But there is
        a resistance movement, too, which joins forces with a data courier to
        thwart Big Pharma executives’ plan to withhold a cure for the plague so
        they might profit from a costly treatment program.
        <br />
        <br />
        <br />
        <br />
        ...
        <br />
        <br />
        <span className={styles.specialCursiveThree}>2024</span>Warming currents
        in the Atlantic Ocean have produced a new Ice Age that spreads rapidly
        across the Northern Hemisphere. Superstorms overwhelm Canada and Europe.
        Tornados break over Los Angeles and hailstorms pummel Tokyo. Manhattan
        is knee-deep in floodwaters. Would-be climate refugees from the United
        States must cross frozen tundras to reach Mexico, a journey punctuated
        by perilous run-ins with animals escaped from local zoos.
        <br />
        <br />
        <br />
        <br />
        ...
        <br />
        <br />
        <span className={styles.specialCursiveThree}>2027</span> An inexplicable
        fertility crisis has befallen the world. Humanity is dying out: Baby
        Diego, the planet’s youngest person at age 18, is stabbed outside a bar
        for refusing to sign an autograph. Economies have collapsed. The UK has
        become a totalitarian police state; vast territories are under military
        occupation and migrants are targeted for mass deportation. Bomb attacks
        in urban centers have become so common that it’s all you can do to hold
        onto your morning coffee as you make your way to the office.
        <br />
        <br />
        <br />
        <br />
        ...
        <br />
        <br />
        <span className={styles.specialCursiveThree}>2029</span> A singularity
        created by a private corporation that was once the world’s biggest
        supplier of military computer systems has developed a mind of its own
        and concluded that human beings are a threat to its survival. This
        neural-networked entity manufactures a nuclear war between the US and
        Russia to exterminate most of humanity; those who survived are hunted by
        a squadron of killer robots. But time travel is possible, and the hope
        is that an intervention into the past can reverse the horrors of the
        present.
        <br />
        <br />
        <br />
        ...
        <br />
        <br />
        <span className={styles.specialCursiveThree}>2035</span>Now a global
        airborne virus has wiped out nearly everyone on Earth except for the one
        percent of our species that has been driven underground. The survivors
        once again seize upon the promise of time travel as a strategy to
        ...
        <br />
        <br />
        <span className={styles.specialCursiveThree}>4001</span>Humanity has
