    ...
    <>
      ...
      <RightBlackTitle>
        <span className={styles.titleShadow}>
          fo<span className={styles.uppercase}>n</span>
          <span className={styles.uppercase}>d </span>
          <br />w<span className={styles.uppercase}>i</span>t
          <span className={styles.uppercase}>h</span>
          <br />p <span className={styles.uppercase}>r </span>ope
      ...
      <LeftBlackTitle>
        <span className={styles.titleShadow}>
          nu<span className={styles.uppercase}>t</span>s
      ...
      <LeftBlackTitle>
        <span className={styles.titleShadow}>
          u<span className={styles.uppercase}> tt </span>
          <i>e</i>
      ...
      <span className={styles.nameHeight}>
        <span className={styles.nameShadowUppercase}> l </span><br/>o<br/>
        <span className={styles.inverseNameShadow}> g</span><br/>{" "}
        <span className={styles.nameShadow}>_ </span>
        <span className={styles.specialCursive}>a</span><br/>
        <span className={styles.rightMargin}>
        <span className={styles.inverseNameShadow}> n </span></span>
        </span>
      </RightBlackTitle>
      <br />
      <br />
      ...
      <br />
      <LeftBlackTitle>
        <span className={styles.nameShadowUppercase}>f</span>
        <br />
        <br />
