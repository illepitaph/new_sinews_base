...
Old.title =
  "brendan white ~ search for your name ++ for its own nourishment ++ — new_sinews";
Old.pieceName =
  "brendan white ~ search for your name ++ for its own nourishment ++ — new_sinews";
Old.description = "_Brendan White_poetry_5 POEMS_issue10_";
Old.image = "https://www.newnewsinews.com/images/DrugBackground.jpg";
    ...
    <>
      ...
      <LeftBlackTitle>
        <span className={styles.nameHeight}>
          <span className={styles.nameShadowUppercase}> b </span>
          <br />
         ...
         n
          <br />
          <span className={styles.nameShadowUppercase}> d </span>
          <br /> <span className={styles.specialCursive}>a</span>
          <br />
          <span className={styles.rightMargin}>
          ...
          <br />
          <br />
          <span className={styles.inverseNameShadow}>w </span>
          <br /><br />
          <span className={styles.specialCursive}>h</span> <br />
          <span className={styles.rightMargin}>
            <span className={styles.nameShadowUppercase}>_ i</span>
          ...
          <br />
          <span className={styles.nameShadowSpecial}>&#10917;</span>
          <br />
          &#10917;
          <br />
          <span className={styles.inverseNameShadow}>&#10917; </span>
