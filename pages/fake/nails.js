...
Nails.image = "https://www.newnewsinews.com/images/TargetBackground.jpg";

export default function Nails() {
  return (
    <>
      <Head />
      <Header headerBackground="nailsBackground" />
      <LeftGrayTitle>
        <span className={styles.duskShadow}>
          <span className={styles.duskShadowUppercase}>n</span>
          <span className={styles.inverse}>
            {" "}
            <span className={styles.headerIndent}>a</span>{" "}
          </span>
          ...
          <span className={styles.inverseUppercase}>
            {" "}
            <span className={styles.headerIndentTwo}>l</span>
          </span>
      ...
      <br />
      <StandardProse>
        Driving past the houses of dead Lexingtoners I paused the book and
        ...
        <span className={styles.grayShadow}>
          Swallowing White Buddhism While Driving.
        </span>{" "}
        Thought: possibly I’m ready to swallow White Buddhism. Possibly I’m
        ready. <br />
        <br />
        <br />
        To write.
        <br />
        <br />
        <br />I had convinced myself fairly strongly that I wouldn’t or couldn’t
        write about the beginning of the plague years because, topographically,
        rather than happening around me, it was happening <i>with</i> and{" "}
        <i>on</i> me. (They are still happening with me! These years) With us.
        <br />
        <br />
        <br />
        We had been told that, due to a forced poverty of sexual activity,
        aspects of our personalities would emerge that had been kept dormant,
        lending a renewed aptitude for everyday social life. Learn crafts, the
        art of something, living perhaps. Going on Zoom dates. Seeing this as
        yet another axiom in line with self-care capital-extraction, I convinced
        myself, with regards to myself, that there was nothing left to learn.
        However,
        <br />
        <br />
        <br />
        This was what autonomy earned. Scrolling back and forth through my
        matches.
        <br />
        <br />
        <br />
        Walking in the Arnold Arboretum with C., then back to her house where I
        was promptly saluted and sent on my way, despite being promised a cup of
        green tea. Thinking it had gone well. Walking across Harvard’s
        ...
        <br />
        <br />
        I’d refused to begin writing this, I told myself, because of time. Since
        this was happening <i>with</i> me, and seeing as I have (writing this)
        no indication of when it will end, the only conclusive point I am
        capable of imagining (having <i>at hand</i>, very literally) is that of
        my own life. The end of my life. The threshold of a time period is the
        point past which I can no longer be said to exist in it, except in the
        memory of those who have loved me, which is to say, those who have
        allowed my bones to be broken and buried.
        <br />
        <br />
        <br />
        ...
        <br />
        <br />
        Not wanting to be honest with myself about my stupidity—not lack of
        knowledge, but its limit, its <i>founding</i> limit. I hear 2.01 million
        worldwide and can’t attach such a number to human lives. Rather than
        investigate this, I forget the number until someone says it out loud
        again. I feel nothing in regards to loss of life within the expression
        of a number. Rather, I feel the emotion behind such a number I can’t
        comprehend. To quantify, in a way, is comparing two objects. Surplus
