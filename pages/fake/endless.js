  ...
  return (
    <>
      ...
      <pre className={styles.title}>
        ...
        <span className={styles.cursiveThree}><span className={styles.uppercase}>s</span></span>
        </span>
      </pre>
      <br />
      <br />
      ...
      <StandardProse>
        ...
        <br />
        <br />I was going through a medieval phase—and my mother, a daring early
        ...
        set. Which was Westwood Gold Label, and <i>way</i> too cool for Willard:
        Oh, Westwood, another parent at the party said, my mother-in-law has
        their tea set.
        <br />
        <br />
