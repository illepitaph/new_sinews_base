    ...
    <>
      ...
      <RightBlackTitle>
        <span className={styles.nameHeight}>
          <span className={styles.nameShadowUppercase}> v </span>
          <br />
          ...
          <br />
          <span className={styles.rightMargin}>
            <span className={styles.inverseNameShadow}>_ e </span>
          </span>
          <br />
          <br />
          <br />
          <br />
          <span className={styles.nameShadowUppercase}> h </span>
          <br />
          ...
          <br />n<br />
          <span className={styles.specialCursive}> g </span>
          <br />
          <br />
