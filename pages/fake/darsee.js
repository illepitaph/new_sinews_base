    ...
    <>
      ...
      <CenterBlackTitle>
        <span className={styles.titleShadow}>
          di<span className={styles.uppercase}>s</span>cl
          <span className={styles.uppercase}>a</span>ime
          <span className={styles.uppercase}>r</span> ++ s
          <span className={styles.uppercase}>e</span>lf-portr
          ...
          <span className={styles.uppercase}>l</span>f-p
          <span className={styles.uppercase}>o</span>r
          <span className={styles.uppercase}>t</span>r
          <span className={styles.uppercase}>a</span>it ++ sel
          <span className={styles.uppercase}>f</span>-
          <span className={styles.uppercase}>p</span>o
          <span className={styles.uppercase}>r</span>t
          <span className={styles.uppercase}>ra</span>i
          <span className={styles.uppercase}>t</span> <br />
          <br />
          <br />
          <span className={styles.uppercase}>s</span>e
          <span className={styles.uppercase}>l</span>f-po
          <span className={styles.uppercase}>r</span>t
          <span className={styles.uppercase}>r</span>a
          <span className={styles.uppercase}>i</span>t ++ <br />i m
          <span className={styles.uppercase}>a</span>ke
          <span className={styles.uppercase}> a </span> bee
          <span className={styles.uppercase}>l</span>i
          <span className={styles.uppercase}>n</span>e t
          <span className={styles.uppercase}>o </span> the w
          <span className={styles.uppercase}>a</span>te
          <span className={styles.uppercase}>r </span>c
          <span className={styles.uppercase}>oo</span>le
          <span className={styles.uppercase}>r</span>
          <br />
          <br />
          <br />
          self-portrait // n<span className={styles.uppercase}>o </span>m
          <span className={styles.uppercase}>a</span>tte
          <span className={styles.uppercase}>r </span>ho
          <span className={styles.uppercase}>w </span>h
          <span className={styles.uppercase}>a</span>rd i
          <span className={styles.uppercase}>t</span> g
          <span className={styles.uppercase}>e</span>ts //
          <span className={styles.uppercase}> self-portrait</span>
        </span>
      </CenterBlackTitle>
